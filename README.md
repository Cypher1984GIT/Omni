...
| OS | Link |
| :--- | :--- |
| **Windows** | [Download .exe](https://github.com/Cypher1984GIT/Omni/releases/download/v1.0.0/Omni.Setup.1.0.1.exe) |
| **Linux** | [Download .AppImage](https://github.com/Cypher1984GIT/Omni/releases/download/v1.0.0/Omni-1.0.1.AppImage) |
